...
<?php
		...
		$privatekey = "6Ld8XeASAAAAAAO9yEfEGZC-J0E8Wdn18EM2KnCc";
			...
			if(trim($_POST['checking']) !== '') {
				...
				if (($resp->is_valid) && (!isset($hasError))) {
					$emailTo = 'jason@jasonsayre.com'; // here you must enter the email address you want the email sent to
		...
		<?php // if there are errors in the form show a message ?>
			...
			<form id="contactForm" action="" method="post">
				...
				<?php
					...
					$publickey = "6Ld8XeASAAAAAHAMVJ7jqsT5O3RRlBfVrzYfLt80";
